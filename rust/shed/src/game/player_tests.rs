...
mod player_tests {
    ...
    fn test_hand_to_actions() {
        let mut player = Player::new(0);
        let mut hand = vec![
            Card::new(Suit::Spades, Rank::Ace), Card::new(Suit::Diamonds, Rank::Ace), Card::new(Suit::Hearts, Rank::Nine),
            Card::new(Suit::Hearts, Rank::Two), Card::new(Suit::Diamonds, Rank::Two), Card::new(Suit::Hearts, Rank::Two), Card::new(Suit::Clubs, Rank::Two),
        ...
        assert_eq!(actions, vec![Action::Ace, Action::Two, Action::Nine, Action::Queen]);
    }
}